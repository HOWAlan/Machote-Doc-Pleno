...
\papersizeswitch{a4paper}{
    ...
    \setulmarginsandblock{20mm}{-10mm}{*}
    ...
    \papersizeswitch{a4paper}{
        ...
        \settypeblocksize{1934pt}{948.13pt}{*}
        \setulmargins{2cm}{*}{*}
        \setlrmargins{*}{*}{1}
        \setmarginnotes{17pt}{41pt}{\onelineskip}
...
%     \showtrimson
%     \papersizeswitch{a4paper}{\stockaiv}{\stockaiii}
...
\usepackage{color}          % Defined more color names
...
\makechapterstyle{mychapterstyle}{
    ...
    \renewcommand*{\chapnumfont}{\format\fontsize{44}{44}\selectfont}
